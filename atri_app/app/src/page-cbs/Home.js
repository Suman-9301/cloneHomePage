...
export function useappNamesCb() {
	const onClick = useCallback(callbackFactory("appNames", "Home", "/", "onClick", 
			{
  "handlers": [
    {
      "sendEventData": true
...
export function useTestimonial2Cb() {
	const onClick = useCallback(callbackFactory("Testimonial2", "Home", "/", "onClick", 
			{
  "handlers": [
    {
      "sendEventData": true
